...
| **FileAccess** | **Состав:** FileID(8) + UserID(8) + CreatedAt(8) + UpdatedAt(8) = **≈32 B**<br>**Количество записей:** 45.5 млрд файлов × 0.3 = **13,650,000,000** | **≈490 ГБ** | **13,650,000,000** | **200**<br>(изменение видимости) | **1650**<br>(скачивание файлов) |
...
|--------|----------------------|------------------|
| **Сервис загрузки данных → FileMetadata** | `FileID`, `Url`, `Hash` | Асинхронная передача информации о загруженном файле.|
