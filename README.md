...
| **FileMetadata** | `45,500,000,000 записей × 391 bytes`<br>Состав: ID(8) + FileName(100) + FileType(50) + FileVolume(8) + FileMode(1) + BaseUrl(200) + DirectoryID(8) + CreatedAt/UpdatedAt(16)<br>Расчет записей: `45.5 млрд файлов` | **17.8 TБ** | **1900 RPS**<br>(загрузка + удаление) | **18 RPS**<br>(листинг + скачивание) |
