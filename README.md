...
| **Cassandra**                  | База данных прав доступа (FileAccess)     | Нереляционная СУБД с горизонтальным масштабированием. Подходит для хранения публичных ссылок.                                                                    |
...
| **ClamAV**                    | Внешний антивирус для проверки загружаемых файлов    | Открытое антивирусное решение с поддержкой обновляемых сигнатур и интеграцией через API. Проверяет файлы на вирусы при загрузке|
