...
### Общая нагрузка на домен `data` (Москва + регионы)
| Компонент          | Пиковый RPS | CPU         | RAM         | Трафик          |
| ------------------ | ----------- | ----------- | ----------- | --------------- |
| **Access_Service** | 7375        | 74 CPU  | 7.7 GB  | 103 Мбит/с  |
| **AV_Scanner**     | 2750        | 275 CPU | 27.6 GB | 14.4 Гбит/с |
| **S3 Gateway**     | 6875        | 688 CPU | 69 GB   | 372 Гбит/с  |
| **NGINX L7**       | 7375        | 19 CPU  | 0.19 GB | 103 Мбит/с  |
| **NGINX L4**       | 6875        | 18 CPU  | 0.18 GB | 372 Гбит/с  |
